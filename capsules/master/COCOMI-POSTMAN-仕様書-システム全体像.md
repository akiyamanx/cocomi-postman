...
| **Cloudflare Workers** | LINE Webhook処理 | worker.js v2.4デプロイ中 |
...
| Worker v2.0 | 2026-02-24 | 安全バリデーション |
| Worker v2.1 | 2026-02-26 | リッチメニュー対応コマンド（ヘルプ/読む/状態エイリアス） |
| Worker v2.2 | 2026-02-26 | Flex Messageタップ式ファイル閲覧 |
| Worker v2.3 | 2026-02-26 | ページネーション＆ファイル名降順ソート |
| Worker v2.4 | 2026-02-26 | 日付抽出ソート＆日付別行表示＆ファイル名短縮 |
